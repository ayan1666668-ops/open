...
| `workboard_link`                                                                                                                                 | Link a parent to a child card. Unblocked children stay `todo` until every parent reaches `done`, then dispatch promotion moves them to `ready`. Blocked children stay `blocked` until claim or unblock. |
| `workboard_claim`                                                                                                                                | Claim a card for the calling agent; moves `backlog`/`todo`/`ready` into `running`. A blocked card with finished parents also moves to `running`; other blocked cards stay `blocked`.                    |
