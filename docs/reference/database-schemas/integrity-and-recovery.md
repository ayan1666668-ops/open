...
root work is idle. Snapshot allocation only creates and registers its own token;
...
owner and worker tokens, applies a grace period to current staging directories,
and stops at a bounded copied-byte budget. Active, recent, over-budget, or
