...
Changed-extension PR jobs use [measured fallback rates and a 320-second packing budget](/ci/capacity#runner-registration-budget) within the unchanged matrix row caps.
