...
Background exec commands retain a bounded, redacted output tail in the task
result (`tasks.get` / `openclaw tasks show` and the Control UI output view
surface it; list and event summaries keep only the generic terminal summary).
