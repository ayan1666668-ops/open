...
<ParamField path="thinking" type="string">
  Override thinking level for the sub-agent run. With `visible: true`, an explicit value is persisted during session creation; omitting it preserves the configured/default behavior.
</ParamField>
