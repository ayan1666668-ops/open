...
| Hook                                                    | Runs                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `before_model_resolve`                                  | Pre-session (no `messages`), to classify the prompt and deterministically override provider/model before resolution; hosts advertising `model-effort-v1` may also return the paired reasoning effort and a notice delivered before dispatch.                                                                                                                                                                           |
