...
<AccordionGroup>
  ...
  <Accordion title="TUI - M2 Alpha - 5 areas">
    ...
    <div className="maturity-surface-rollup"><span>Coverage Stable - 83%</span><span>Quality Alpha - 59%</span><span>Completeness Alpha - 66%</span><span><span className="maturity-lts maturity-lts-none">None</span></span></div>
