...
export const icons = {
  ...
  brandX: strokeIcon(svg`<path d="m4 3 12 18h4L8 3Z"/><path d="m4 21 6.5-7.5M13.5 10.5 20 3"/>`),
  discord: strokeIcon(
    svg`<path d="M8 4 7 3 4 4C2 8 1 12 2 17l5 3 1-2m8-14 1-1 3 1c2 4 3 8 2 13l-5 3-1-2"/><path d="M8 5a16 16 0 0 1 8 0M6 16c4 3 8 3 12 0"/><ellipse cx="8" cy="12" rx="1.5" ry="2"/><ellipse cx="16" cy="12" rx="1.5" ry="2"/>`,
  ),
  reddit: strokeIcon(
