...
describe("chat pane placement", () => {
  it("dispatches a local repository-only session to an authoritative worker target", async () => {
    ...
    expect(request).toHaveBeenCalledWith("environments.list", { runtimeId: "auto" });
