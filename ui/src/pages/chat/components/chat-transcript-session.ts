...
import type { ChatScrollDirection, ChatSessionScrollPosition } from "../scroll.ts";
...
export type TranscriptCallbacks = {
  ...
  onReaderScroll?: (direction?: ChatScrollDirection) => void;
  onScrollAdjustment?: (adjustment: number) => void;
