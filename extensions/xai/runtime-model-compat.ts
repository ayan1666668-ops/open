...
import { isXaiFrontierModelId, supportsXaiXHighReasoning } from "./model-id.js";
...
export function applyXaiRuntimeModelCompat<T extends XaiRuntimeModelCompat>(
  ...
  return {
      ...
      ...(supportsReasoningEffort
        ? {
            supportedReasoningEfforts: [
              ...
              ...(supportsXaiXHighReasoning(id) ? ["xhigh"] : []),
            ],
          }
        : {}),
    },
    thinkingLevelMap: {
      ...
      ...(supportsReasoningEffort && supportsXaiXHighReasoning(id) ? { xhigh: "xhigh" } : {}),
    },
  };
}
