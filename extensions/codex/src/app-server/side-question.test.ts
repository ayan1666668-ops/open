...
import {
  registerSideNativeHookRelayPolicyTests,
  codexHookCommand,
  codexHookStateForEvent,
} from "./side-question-native-hook-relay.test-support.js";
import {
  createClientHarness,
...
const sideQuestionTestSupport = await import("./side-question.test-support.js");
const {
...
describe("runCodexAppServerSideQuestion", () => {
  ...
  registerSideNativeHookRelayPolicyTests(sideQuestionTestSupport, mockCall);
