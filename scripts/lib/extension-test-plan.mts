...
// Native app-server files already run in isolated forks. Keep their measured
// 12-file envelopes within the packing budget instead of inheriting the light lane's cap.
