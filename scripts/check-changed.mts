...
// These ratchet baselines are checked by their own ratchet scripts, not consumed by Oxlint.
const LINT_OPTIMIZATION_NEUTRAL_PATH_RE =
  /^(?:docs\/|README\.md$|.*\.mdx?$|config\/(?:assertion-safety|max-lines)-baseline\.txt$)/u;
