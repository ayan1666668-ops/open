...
import { prepareUpdateCandidateRehearsal, UpdateCandidateRehearsalInUseError } from "./update-candidate-rehearsal.js";
...
vi.mock("../process/scoped-child-reaper.js", () => ({ scheduleAdoptedChildZombieReapAfterExit: mocks.reap }));
