...
describe("mutable update execution", () => {
  it.each(
    ...
    async ({ kind, timeoutMs }) => {
      // This fixture has no Gateway. Leave readiness to the live-listener cases below;
      // claiming a running service here starts real probes that outlive a timed-out test.
