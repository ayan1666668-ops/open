...
export type CreateGatewaySessionParams = {
  ...
  /** Retained entry-commit continuation; callers catch best-effort failures and join native work. */
  afterEntryCommitted?: SessionEntryCreateWithTranscriptOptions["afterCommitted"];
