  ...
  return {
    "projects.list": async ({ params, respond, context, client }) => {
      ...
      try {
        ...
        let combinedStore: ReturnType<typeof loadCombinedSessionStoreForGatewayCore> | undefined;
        ...
        try {
          if (
            ...
            if (params.includeObserved) {
              ...
              combinedStore = loadCombinedSessionStoreForGatewayCore(cfg, {
                projection: "list",
        ...
        const recents =
          recentProfileIds && combinedStore
            ? listProjectRecents(
                combinedStore.store,
                combinedStore.targetsBySessionKey,
                recentProfileIds,
                registryProjects,
              )
            : undefined;
