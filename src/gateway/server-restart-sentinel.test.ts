...
describe("scheduleRestartSentinelWake", () => {
  ...
  it("replays a main-child continuation return only for its helper recipient", async () => {
    ...
    expect(resolveSystemEventOwnerAgentId(eventOptions as object)).toBe("helper");
    const replayedEvent = {};
    recordSystemEventOwner(replayedEvent, resolveSystemEventOwnerAgentId(eventOptions as object));
