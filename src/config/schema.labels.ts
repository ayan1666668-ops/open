...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.otel.skillContentHash": "OpenTelemetry Skill Content Hashing",
  "diagnostics.otel.traceAttributes": "OpenTelemetry Trace Attributes",
  "diagnostics.otel.logAttributes": "OpenTelemetry Log Attributes",
  "diagnostics.otel.metricAttributes": "OpenTelemetry Metric Attributes",
