...
export function getSubagentRunsSnapshotForRead(
  ...
  if (options?.refreshPersisted) {
    // Current-turn catch-up cannot defer another process's committed result to
    // a later read after the ordinary hot-list cache expires.
    persistedSubagentRunsReadCache.snapshot = undefined;
  }
