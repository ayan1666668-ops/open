...
import { registerCompactionSafeguardTests } from "./compact.safeguard.test-support.js";
import {
...
describe("compactEmbeddedAgentSessionDirect hooks", () => {
  ...
  registerCompactionSafeguardTests({
    ...
    compactEmbeddedAgentSessionDirect: (...args) => compactEmbeddedAgentSessionDirect(...args),
    wrappedCompactionArgs,
  });
