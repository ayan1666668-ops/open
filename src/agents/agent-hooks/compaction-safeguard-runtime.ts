...
type CompactionSafeguardRuntimeValue = {
  /** Owner used for per-agent decision-model selection when no persisted session target exists. */
  agentId?: string;
  ...
  /** Judgment-assisted curation of eligible tool output in the temporary summarizer view. */
  semanticJudgmentCurationEnabled?: boolean;
  /**
