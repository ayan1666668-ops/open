...
enum class GatewayMethod(
  ...
  TasksSupervisionList("tasks.supervision.list"),
  TasksSupervisionArtifact("tasks.supervision.artifact"),
  TasksSupervisionGet("tasks.supervision.get"),
  TasksSupervisionControl("tasks.supervision.control"),
  TasksGet("tasks.get"),
