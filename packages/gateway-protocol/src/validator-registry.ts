...
export const validateFilesRootsListParams = compile(S.FilesRootsListParamsSchema);
export const validateFilesRootListParams = compile(S.FilesRootListParamsSchema);
export const validateFilesRootGetParams = compile(S.FilesRootGetParamsSchema);
