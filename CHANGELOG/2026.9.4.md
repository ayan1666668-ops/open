<!-- openclaw-docs-mirror-v1 {"version":"2026.9.4","sources":["docs/releases/2026.9.4.md"],"sourceDigest":"sha256:69e9f38eb08478e3a45df1445cb3d2910b30c907bada5cade727bbd1ffd7082e"} -->
...
![Published 2026.9.4 Add to chat quote flow using the fictional Harbor welcome brief; the quote remains editable and unsent.](https://github.com/user-attachments/assets/07752d86-cc09-428d-abec-d6750cd09afe)

_Bring a specific sentence into the next reply without sending it. Published 2026.9.4 interface with fictional Harbor data; no live task execution._
...
![Conceptual 2026.9.4 explainer: Installed for this agent — Volunteer-brief checklist — Ready or needs setup; Discover on ClawHub — Search for the next capability — Browse before installing. Conceptual catalog, not a claim that these fictional skills exist on ClawHub. Switch agents to change scope.](https://github.com/user-attachments/assets/c9cd5f78-a766-41de-8d05-e7dbbe216fbd)

_Search installed skills and ClawHub from the Skills page. Conceptual illustration, not a screenshot. Conceptual catalog, not a claim that these fictional skills exist on ClawHub. Switch agents to change scope._
...
![Conceptual 2026.9.4 explainer: Auto — Follow the learning chat — Agent can apply improvements; Propose — Follow the same visible work — Review suggestions before approval. You can add direction or stop. Manual learning does not enable automatic self-learning; model charges apply.](https://github.com/user-attachments/assets/3b65dd1c-15d4-4e23-9372-25ffdfa9cd12)

_Start Learn from past conversations in Skill Workshop. Conceptual illustration, not a screenshot. You can add direction or stop. Manual learning does not enable automatic self-learning; model charges apply._
...
![Conceptual 2026.9.4 explainer: Question arrives — Which welcome-brief draft?; Answer or set aside — Choose / type • Esc dismisses; Return when ready — Use /question to reopen. Conceptual, not a terminal capture. Secrets use masked single-line entry; saving needs a Gateway connection.](https://github.com/user-attachments/assets/eae02f7b-28a8-41ee-baa6-3b6d09cdd3da)

_Terminal questions can wait for a choice or a typed response. Conceptual illustration, not a screenshot. Conceptual, not a terminal capture. Secrets use masked single-line entry; saving needs a Gateway connection._
