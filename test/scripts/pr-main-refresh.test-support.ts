...
if (args[0] === 'pr' && args[1] === 'view') {
  ...
  if (endpoint === 'rate_limit') {
    ...
    value = {
      ...
      base: { ref: control.metadata.baseRefName, sha: baseSha, repo: { id: control.metadata.isCrossRepository ? 456 : 123, node_id:'fixture-repo', full_name:'fixture/repo', html_url:'https://github.com/fixture/repo' } },
    };
